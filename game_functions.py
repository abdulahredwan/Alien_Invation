...
def check_play_button(ai_settings, screen, stats, play_button, ship, aliens, bullets,  mouse_x, mouse_y):
    ...
    if button_cliked and not stats.game_active:
        ...
        #Creare a new fleet and center the ship
...
def get_number_aliens_x(ai_settings, alien_width):
    """Determain the number of aliens that fit in a row"""
    available_space_x = ai_settings.screen_width -2 * alien_width
    number_aliens_x = int(available_space_x / (2 * alien_width))
    return number_aliens_x

def get_number_rows(ai_settings, ship_height, alien_height):
    """Determine the number of aliens that filt on the screen"""
...
def check_fleet_edges(ai_settings, aliens):
    """Respond appropritely if any aliens have reached an egge"""
...
def change_fleet_direction(ai_settings, aliens):
    """Drop the entire fleet and checge """
    for alien in aliens.sprites():
...
def check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets):
    """Check if any aliens have been reached the bottom of the screen"""
